...
class StoreFileRequest extends FormRequest
{
    ...
    {
        return [
            'taxNumber.string' => 'رقم التسجيل الضريبي يجب أن يكون نصاً.',
            'taxNumber.max' => 'رقم التسجيل الضريبي يجب أن لا يتجاوز 255 حرف.',

            'inventoryNumber.required' => 'رقم الجرد مطلوب.',
            'inventoryNumber.string' => 'رقم الجرد يجب أن يكون نصاً.',
            'inventoryNumber.max' => 'رقم الجرد يجب أن لا يتجاوز 255 حرف.',
            'inventoryNumber.unique' => 'رقم الجرد موجود بالفعل.',
